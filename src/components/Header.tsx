...
const Header = () => {
  ...
  return (
    <header className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-4 lg:px-8 py-4 shadow-lg relative z-10">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="relative hover:bg-slate-100/80 dark:hover:bg-slate-800/80 backdrop-blur-sm transition-all duration-300">
                <Bell className="h-5 w-5 text-slate-600 dark:text-slate-400" />
                <Badge className="absolute -top-1 -right-1 h-5 w-5 p-0 flex items-center justify-center bg-gradient-to-r from-red-500 to-red-600 text-white text-xs shadow-lg animate-pulse">
                  3
                </Badge>
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-80 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-slate-200/50 dark:border-slate-700/50 shadow-2xl rounded-xl">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="flex flex-col items-start p-4 hover:bg-slate-50/80 dark:hover:bg-slate-800/80 rounded-lg m-1">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-12 w-12 rounded-full hover:bg-slate-100/80 dark:hover:bg-slate-800/80 transition-all duration-300">
            ...
            <DropdownMenuContent className="w-64 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-slate-200/50 dark:border-slate-700/50 shadow-2xl rounded-xl" align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="hover:bg-slate-50/80 dark:hover:bg-slate-800/80 rounded-lg m-1">
              ...
              <DropdownMenuItem 
                ...
                className="text-red-600 dark:text-red-400 hover:bg-red-50/80 dark:hover:bg-red-950/50 rounded-lg m-1"
              >
